 ...
 * 基于 Cloudflare Snippets 的 GitHub 全功能镜像站
 *
 * 代码与 workers.js 完全一致，适用于 Cloudflare Snippets 部署。
 * 注意：Snippets 部署需要确认是否支持 cloudflare:sockets 模块。
 * 如不支持，建议使用 Workers 部署方式（workers.js）。
 *
 * 核心技术：
 ...
 *
 * 部署方式：
 * 在 Cloudflare Dashboard → Snippets 中创建新 Snippet，粘贴本文件代码。
 * 筛选表达式：(http.host eq "your-domain.com")
 */
